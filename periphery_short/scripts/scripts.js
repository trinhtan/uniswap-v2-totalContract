...
const UniswapV2Router02Contract = new web3.eth.Contract(
...
exports.swapExactETHForTokens = async function(
  userPrivateKey,
  value,
  amountOutMin,
  tokens,
  ...
  try {
    ...
    let result = await UniswapV2Router02Contract.methods
      .swapExactETHForTokens(amountOutMin, tokens, to, deadline)
      .send({
        from: user.address,
        value: value,
        gas: process.env.ETH_GAS_LIMIT,
